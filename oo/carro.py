...
compostod por outas duas classes
...
2)Método acelerar, que deverá incrementar a velocodade de uma unidade
3) Método frear que deverá decrementar a velocidade em duas unidades

A direção terá a responsabilidade de controlar a direção. Ela oferece os seguintes atributos.
1 - Valor de direção com valores possoveis Noter, Sul, Leste e Oeste
